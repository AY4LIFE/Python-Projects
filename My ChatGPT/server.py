...
class S(BaseHTTPRequestHandler):
    ...
    database = \
        {
            "name": "I am Ayo231. My nickname is Riley.",
            "hire": "Ayomide is a hardworking team player with strong experience in group projects,"
                    " making him an excellent candidate for your position.",
            "skills": "Ayomide excels in Python and is learning Java, eager to apply his Python skills"
                      " to benefit companies and communities.",
            "education": "Ayomide is currently Computer Science at the University of Calgary. He is in his first year",
            "experience": "Though Ayomide lacks job experience, he placed in the top 15 at"
                          " his school's Competitive Programming Club competition in October 2024."
        }
